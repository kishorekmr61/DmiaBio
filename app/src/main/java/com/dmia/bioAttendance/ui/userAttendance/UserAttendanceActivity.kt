...
import com.dmia.bioAttendance.utils.getdatetime
                ...
                is NetworkResult.Success -> {
                    ...
                    response.data.let { resposnes ->
                        ...
                        if (response.data != null) {
                            ...
                            if (intent.getStringExtra("Checkin") == "Checkin") {
                                AppPreference.write(
                                    ApiConstant.ATTENDANCECHECKINTIME,
                                    getdatetime()
                                )
                                AppPreference.write(
                                    ApiConstant.ATTENDANCECHECKIN,
                                   false
                                )
                                AppPreference.write(
                                    ApiConstant.ATTENDANCECHECKOUT,
                                    true
                                )
                            }
                            if (intent.getStringExtra("Checkout") == "Checkout") {
                                AppPreference.write(
                                    ApiConstant.ATTENDANCECHECKOUTTIME,
                                    getdatetime()
                                )
                                AppPreference.write(
                                    ApiConstant.ATTENDANCECHECKIN,
...
//                progressDialog?.dismiss()
            ...
            if (userLocation.latitude != 0.0 && userLocation?.longitude != 0.0) {
                ...
                else if (intent.getStringExtra("Checkout") == "Checkout") {
                    inout = "OUT"
                }

...
class UserDashboardViewModel @Inject constructor(
    ...
    var checkindatetime = MutableLiveData<String>()
    var checkoutdatetime = MutableLiveData<String>()
    var checkin = MutableLiveData<Boolean>()
    var checkout = MutableLiveData<Boolean>()

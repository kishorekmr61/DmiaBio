...
class EmployeeRegistrationActivity : AppCompatActivity() {
    ...
    var autoCompleteTextView: EditText? = null
    var getEmployess: MutableList<String>? = null
    var progressDialog: ProgressDialog? = null
    var employees_list: RecyclerView? = null
    var employeename = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        employees_list = findViewById(R.id.employees_list)
            ...
            when (response) {
                ...
                is NetworkResult.Error -> {
                    ...
                    showDialog(
                        ...
                        /*getString(R.string.empid_not_found)*/response.message,
    ...
    fun employeeWarningMessage(userdata: UsersData) {
        ...
        deactivate_txt.text =
            ...
            } is your EmployeeID & Name ,Please check once again before registering."

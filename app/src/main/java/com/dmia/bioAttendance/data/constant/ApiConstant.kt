...
interface ApiConstant {
    ...
    companion object {
        ...
        const val ATTENDANCECHECKINTIME = "ATTENDANCECHECKINTIME"
        const val ATTENDANCECHECKIN = "ATTENDANCECHECKIN"
        const val ATTENDANCECHECKOUTTIME = "ATTENDANCECHECKOUTTIME"
        const val ATTENDANCECHECKOUT = "ATTENDANCECHECKOUT"
